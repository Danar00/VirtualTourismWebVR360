...
@endif
  <div class="main">
    ...
    <form class="form1" action="{{ url('/loginPost') }}" method="post">
        ...
        <button type="submit" name="submit" class="submit" align="center">Sign in</button><br>
        <p class="forgot" align="center">Not registered? <a href="register">Create an account</a></p>
        {{ csrf_field() }}
    </form>
  </div>
</body>
...
{{-- action="{{ url('/loginPost') }}" method="post" --}}
